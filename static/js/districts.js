...
var accessToken = "pk.eyJ1Ijoic3Jtb250ZWlybyIsImEiOiJjandyMTJzNjgwMDgyNDNwZDUwNWpkN2NoIn0.rggDqMijR64cH-l9E6JVag";
...
if (mapboxgl.supported({ failIfMajorPerformanceCaveat: true })) {
  ...
  var map = L.mapbox.map('district').setView(continental.center, continental.zoom);
